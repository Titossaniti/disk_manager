    ...
    (
        ...
        return (
            ...
            >
                <div
                    className={cn(
                        'group rounded-md border border-input bg-background ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2',
                        className
                    )}
                >
                    <div
                    ...
                    >
                        ...
                        <div className="flex-1 flex items-center">
                            ...
                            />
                            <ChevronDownIcon className="h-4 w-4 shrink-0 opacity-50 ml-1" />
                        </div>
                    </div>
                </div>
